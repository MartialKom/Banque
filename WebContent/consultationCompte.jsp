...
<body>
  ...
  format.setDecimalFormatSymbols(s);
              ...
              out.println("<th><a href='Crediter.jsp?param="+compte.numero+"&param2="+compte.nomU+"' target='zone1' ><button style='border-radius:20px;'  class='btn btn-primary btn-block bt'>Crediter</button></a>");
              out.println("<th><a href='Debiter.jsp?param="+compte.numero+"&param2="+compte.nomU+"' target='zone1' ><button style='border-radius:20px;'  class='btn btn-primary btn-block bt'>Debiter</button></a></th>");
              out.println("</tr>");
              i++;
                }
